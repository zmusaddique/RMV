    ...
    <div class="container">
        <div class="row">
            <div class="page-header">
                <h1 style="text-align:center;">Enter PUC Details</h1>
                <?php //echo $msg; 
                ?>
            </div>
            <div class="col-md-3"></div>
            <div class="col-md-6">
                <form class="animated bounce" action="bookingactionPUC.php" method="post">
                    ...
                    <br>
                    <div class="input-group">
                        <span class="input-group-addon"><b>PUC Expires On</b></span>
                        <input id="uid" type="text" class="form-control" name="pucexp" placeholder="In format yyyy-mm-dd">
                    </div>
                    <br>
