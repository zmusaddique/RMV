<!-- <?php
        ...
        //     $email_message = " This is an email form Vehicle Management to confirm your vehicle. Details are given below.\n\n";
...
<body>
    <form class="" action="send.php" method="post">
        ...
        Subject <input type="text" name="subject" value="<?php $_SESSION['subject']; ?>"><br>
